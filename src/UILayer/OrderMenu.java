...
public class OrderMenu {
	...
	public void endSale(String phone, int id) {
		...
		System.out.println("2. for at fors�tte med normal pris");
		...
		String bekr�ft = keyboard.next();
		if (bekr�ft.equals("nej")) {
	...
	public void printInvoice() {
		...
		System.out.println("Fakturanr.: " + orderCtr.findOrder(id).getId() + "              " + "Dato:"
				+ orderCtr.findOrder(id).getDate());
